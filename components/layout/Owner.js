            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
              <div className="hidden sm:block">
                <div className="flex">
                  <a
                    href="/dashboard"
                    className={`px-3 py-2 rounded-md text-sm font-medium leading-5 text-white ${
                      router.route === "/dashboard" && "bg-gray-900"
                  ...
                  <a
                    ...
                    className={`ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 ${
                      router.route === "/centers" && "bg-gray-900"
                    } text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out`}
                  >
                    Centers
                  </a>
                  <a
